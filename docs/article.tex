...
\section{Uvod}
    ...
    emojije ter namerne pravopisne napake, ki jih pošiljatelji uporabljajo za obhod filtrov~\cite{almeida2013sms}. 
    Zaradi omejene dolžine besedila imajo modeli na voljo manj semantičnega konteksta kot pri elektronski pošti, 
    kjer so prisotni daljši stavki, zadeve sporočil, HTML struktura in metapodatki~\cite{cormack2007shortmessages}. 
    Poleg tega SMS komunikacija pogosto vključuje mobilno-specifične značilnosti, kot so telefonske številke, 
    časovni vzorci pošiljanja in omrežni podatki, ki jih pri elektronski pošti ni ali pa imajo drugačno strukturo~\cite{Xu2012Noncontent}. 
    ...
    in predobdelave besedila~\cite{cormack2007feature}.
