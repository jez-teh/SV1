...
\section{Lastna ideja}
    ...
    učenje in vrednotenje modelov znotraj enega jezika, najpogosteje angleščine~\cite{shirani2013,sethi2017}. Tak 
    ...
    označevanja~\cite{pires2019}. Za izhodišče reproduciramo eksperimente Shirani-Mehra~\cite{shirani2013}. Pristop uporablja 
    ...
    oznake. Testiranje bomo izvedli v tudi v drugo smer, torej vzeli bomo slovenska sporočila in jih prevedli v angleščino,
    nato pa jih klasificirali z modelom, naučenim na angleških podatkih, ter primerjali z klasifikacijo, ki jo dobimo, če jih
