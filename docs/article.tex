...
\caption{Primerjava metrike F1 med mBERT in TinyBERT modelom glede na število few-shot primerov.}
...
Pri TinyBERT modelu pa vidimo bolj dinamičen odziv na few-shot učenje. Pri k=100 je model dosegel najboljšo F1 vrednost (0,8888), kar je izboljšanje za 0,0018 glede na zero-shot scenarij. To nakazuje, da manjši modeli bolj koristijo dodatne podatke v ciljnem jeziku. Zanimivo je, da k=10 ni privedel do izboljšanja pri TinyBERT, temveč je F1 padla na 0,8486, kar morda kaže na premajhno količino podatkov za stabilno prilagajanje.
...
\textbf{Za mobilne naprave:} TinyBERT je primeren izbor za lokalno obdelavo na napravah z omejenimi viri. Čeprav je zmogljivost nižja, se lahko z le 50-100 primeri slovenskih sporočil zmanjša razlika od mBERT-a. To je ključno za sisteme, ki potrebujejo visoko stopnjo zasebnosti in delovanje brez internetne povezave.
