...
\subsection{Izvedba eksperimenta}
    ...
    V eksperimentih smo primerjali tri večjezikovne transformatorske modele: mBERT (110M parametrov)~\cite{devlin2019}, 
    XLM-RoBERTa (270M parametrov)~\cite{conneau2020} in TinyBERT (15M parametrov)~\cite{jiao-etal-2020-tinybert} za mobilne naprave.
