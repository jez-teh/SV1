...
\begin{enumerate}
    ...
    \item \textbf{Prevedi in razvrsti (translate-then-classify)}: Slovenska sporočila smo strojno prevedli v angleščino in jih klasificirali z modeli, naučenimi na angleških podatkih, kar služi kot primerjava za vpliv kakovosti prevoda na detekcijo.
